...
class DatabaseSettings(BaseSettings):
    ...
    URL: str = "postgresql+asyncpg://postgres:secret@localhost:5432/postgres"
    ...
    PORT: int | None = None
    NAME: str | None = None
    MIGRATION_CONFIG: str = f"{BASE_DIR}/alembic.ini"
    MIGRATION_PATH: str = f"{BASE_DIR}/migrations"

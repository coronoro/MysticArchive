...
#
#
# db_config = SQLAlchemyAsyncConfig(connection_string="sqlite+aiosqlite:///C:/MysticArchive.sqlite")
#
# app = Litestar(
#     [CardController, ],
...
db_config = SQLAlchemyAsyncConfig(connection_string="sqlite+aiosqlite:///C:todo.sqlite")

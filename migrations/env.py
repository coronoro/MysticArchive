...
from app.settings.settings import db as db_config
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        # user_module_prefix=db_config.user_module_prefix,
        # render_as_batch=db_config.render_as_batch,
...
def do_run_migrations(connection: Connection) -> None:
    ...
    context.configure(
        ...
        target_metadata=target_metadata,
        # compare_type=db_config.compare_type,
        # version_table=db_config.version_table_name,
        # version_table_pk=db_config.version_table_pk,
        # user_module_prefix=db_config.user_module_prefix,
        # render_as_batch=db_config.render_as_batch,
        process_revision_directives=writer,  # type: ignore[arg-type]
    )
...
async def run_migrations_online() -> None:
    ...
    configuration["sqlalchemy.url"] = db_config.URL
